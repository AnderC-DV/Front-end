...
const TemplateReviewModal = ({ template, onClose, onReview }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex justify-center items-center z-50">
      <div className="bg-white/80 backdrop-blur-lg rounded-xl shadow-xl p-8 max-w-2xl w-full border border-white/20">
        <h2 className="text-2xl font-bold mb-4 text-gray-800">Revisar Plantilla</h2>
